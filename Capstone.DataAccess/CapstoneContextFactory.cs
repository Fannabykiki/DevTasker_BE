...
namespace Capstone.DataAccess
{
    public class CapstoneContextFactory : IDesignTimeDbContextFactory<CapstoneContext>
    {
        ...
        {//
            ...
            optionsBuilder.UseSqlServer("Server=capstone.cdmygx4w4t6p.ap-southeast-1.rds.amazonaws.com;uid=admin;Password=PhanNam2001;Database=Capstone;TrustServerCertificate=True;Encrypt=True");
