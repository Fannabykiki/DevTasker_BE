...
namespace Capstone.Service.IterationService
{
    ...
    public class InterationService : IInterationService
    {
        ...
        public InterationService(CapstoneContext context, IProjectRepository projectRepository, IMapper mapper, IInterationRepository iterationRepository, IBoardRepository boardRepository, ITicketRepository ticketRepository)
        {
            _context = context;
        ...
        //public async List<BoardResponse> GetBoardsByInterationId (Guid interationId)
        //{
        //    return 
        //}
