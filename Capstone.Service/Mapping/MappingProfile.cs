...
public class MappingProfile : Profile
{
    public MappingProfile()
    {
		...
		CreateMap<ProjectMember, GetAllProjectViewModel>()
			...
			.ForPath(dest => dest.MemberRole.RoleId, opt => opt.MapFrom(src => src.Role.RoleId))
			.ForPath(dest => dest.MemberRole.RoleName, opt => opt.MapFrom(src => src.Role.RoleName))
			.ForPath(dest => dest.MemberRole.Description, opt => opt.MapFrom(src => src.Role.Description))
